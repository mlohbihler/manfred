...
/**
 * Copied from sero-utils to change logger implementation.
 */
public abstract class BaseIOLog {
    private static final Logger LOGGER = LoggerFactory.getLogger(BaseIOLog.class);
    ...
    protected void createOut() {
        try {
            ...
            LOGGER.error("Error while creating process log", e);
        }
    }
