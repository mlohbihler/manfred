...
public interface GpioFactory {
    ...
    public static class RealGpioFactory implements GpioFactory {
        @Override
        public GpioController get() {
            return com.pi4j.io.gpio.GpioFactory.getInstance();
        }
    }

    public class FakeyGpioFactory implements GpioFactory {
        @Override
        public GpioController get() {
            return new FakeyGpioController();
        }

        static class FakeyGpioController implements GpioController {
            @Override
            ...
            @Override
            public GpioPinDigitalMultipurpose provisionDigitalMultipurposePin(GpioProvider provider, Pin pin,
                    String name, PinMode mode, PinPullResistance resistance) {
                // TODO Auto-generated method stub
                return null;
            }
