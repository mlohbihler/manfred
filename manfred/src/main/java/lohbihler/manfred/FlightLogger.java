...
public class FlightLogger {
	...
	private FlightLogger() {
		...
		// Load properties file. Do this first because the properties file is
		// necessary for determining how
			...
			try (final Scanner in = new Scanner(System.in)) {
				...
				while (true) {
					try {
						...
						LOGGER.info("Read did not block. Sleeping before trying again.");
						Thread.sleep(5000);
					}
				}
				LOGGER.info("Exiting");
